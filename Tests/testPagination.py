  ...
  def __init__(self, master, displayed_pages, total_pages, background=None, current_page=None, start_page=1,
    ...
    for selected_state in (NOT_SELECTED, SELECTED):
      for active_state in (NORMAL_STATE, ACTIVE_STATE):
        style_config[selected_state, active_state] = self._create_configuration_of_state(pagination_style,
                                                                                         selected_state, active_state)

    self._render_pagination(current_page, prev_button, next_button, first_button, last_button, displayed_pages,
                            self._start_page, self._end_page, self._label_spacing, hide_controls_at_edge)
  ...
  def _render_pagination(self, current_page, prev_button, next_button, first_button, last_button, displayed_pages,
    ...
    for page_number in range(start_page, start_page + displayed_pages):
      ...
      if page_number <= end_page:
        page_label = Page_Label(self._page_frame, page_number, self._style_config, self._on_click_page, is_selected,
